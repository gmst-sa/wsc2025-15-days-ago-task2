...
echo =====1-3-A=====
aws events describe-rule --name account-conflict-event --query "Name" --output text
echo

echo =====1-4-A=====
APP_SRV_PUBLIC_IP=$(aws ec2 describe-instances --query "Reservations[].Instances[].PublicIpAddress" --output text)
